    ...
    <html lang="en">
      ...
      <div className="flex max-w-screen-xl mx-auto w-full">
        <div className="flex flex-wrap items-center lg:gap-y-2 gap-4 w-full">
          <a href="" className="max-sm:hidden"><img src="https://i.ibb.co.com/Dfr0tBpr/android-chrome-512x512.png" alt="logo" className="w-10 h-10" />
          </a>
          <a href="" className="hidden max-sm:block"><img src="https://i.ibb.co.com/Dfr0tBpr/android-chrome-512x512.png" alt="logo" className="w-10" />
          </a>
            ...
            <ul
              ...
              <li className="mb-6 hidden max-lg:block">
                <div className="flex items-center justify-between gap-4">
                  <a href=""><img src="https://i.ibb.co.com/Dfr0tBpr/android-chrome-512x512.png" alt="logo" className="w-36" />
                  </a>
                  <button
              ...
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href=''
                className="text-blue-700 hover:text-blue-700 text-[15px] block font-semibold">New</a></li>
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href=''
                className="text-slate-900 hover:text-blue-700 text-[15px] block font-semibold">Men</a></li>
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href=''
                className="text-slate-900 hover:text-blue-700 text-[15px] block font-semibold">Women</a></li>
              <li className="max-lg:border-b max-lg:border-gray-300 max-lg:py-3 px-3"><a href=''
                className="text-slate-900 hover:text-blue-700 text-[15px] block font-semibold">Kids</a></li>
            </ul>
          </div>
